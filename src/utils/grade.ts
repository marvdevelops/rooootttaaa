...
export function classifyGradeRuns(path: PathPoint[]): { points: PathPoint[]; runs: GradeRun[] } {
  ...
  // Absorb short runs into whichever neighbor is longer, until everything
  // left is either long enough or there's only one run remaining.
