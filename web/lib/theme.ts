// Mirrors src/theme/theme.ts on mobile — one design system, two runtimes.
// CSS custom properties in app/globals.css carry the same values for
// stylesheet/className-based styling; these JS exports are for places that
// need the raw value (inline style props, canvas/SVG drawing, JS logic).
